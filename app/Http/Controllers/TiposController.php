...
class TiposController extends Controller
{
    public function index(){
        ...
        return view('cms.tipos', compact('procesos', 'user'));
    }
    ...
    public function save(Request $r){
        ...
        if($r->procesoId<=0){
            return response()->json(["code"=>401, "msj"=>"Verifique que la información ingresada sea correcta.", "ctrl"=>"procesoId", "msg"=>"Elija un PROCESO."]);
        }
    ...
    public function listarDataT(){
        return Tipos::ListarDataT();
    }
    public function get($id){
        return Tipos::where('id', $id)->first();
    }
}
