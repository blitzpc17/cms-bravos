...
@section('seccion', 'Cátalogo de tipos')

@section('bread')
 <a class="breadcrumb-item" href="">Cátalogos</a>
  <span class="breadcrumb-item active">Tipos</span>
        ...
        <div class="card mg-b-30">
           <div class="card-header">
              <div class="d-flex justify-content-between align-items-center">
                 <div>
                    <h6 class="card-header-title tx-13 mb-0">Cátalogo de tipos</h6>
                 </div>                 
              </div>
           </div>
           <div class="card-body">
            ...
            <div class="modal-body">
                <form id="frm-submit" class="">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="clave" id="clave" class="form-control" placeholder="" aria-describedby="helpId">                      
...
<!-- dataTables Script -->
    ...
    <script>
        ...
        function ListarRegistros(){
            $.get("{{route('tipos.dt.listar')}}", function (data) {
                var html = '';
                $.each(data, function (index, value) { 
                    ...
                    var numeral = index+1;
                     html += '<tr>'+
                             ...
                             '<td style="width:15%;">'+value.clave+'</td>'+
                             '<td style="width:30%;">'+value.nombre+'</td>'+
                             '<td style="width:30%;">'+value.nombreProceso+'</td>'+
        ...
        function Eliminar(id){
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.get("{{url('tipos/eliminar')}}/"+id,function (data) {
        ...
        function Modificar(id){
            $.get("{{url('tipos/get')}}/"+id,function (data) {
                console.log(data)
                LimpiarFormulario();
                $('#procesosId').val(data.procesoId).prop('selected', true);
