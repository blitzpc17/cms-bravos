...
@section('seccion', 'Cátalogo de estados')

@section('bread')
 <a class="breadcrumb-item" href="">Cátalogos</a>
  <span class="breadcrumb-item active">Estados</span>
...
<!-- dataTables Script -->
    ...
    <script>
        ...
        function ListarRegistros(){
            $.get("{{route('estados.dt.listar')}}", function (data) {
                var html = '';
        ...
        function Eliminar(id){
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.get("{{url('estados/eliminar')}}/"+id,function (data) {
        ...
        function Modificar(id){
            $.get("{{url('estados/get')}}/"+id,function (data) {
                console.log(data)
                LimpiarFormulario();
